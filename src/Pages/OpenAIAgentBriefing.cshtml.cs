...
[Authorize]
public class OpenAIAgentBriefingModel(ILogger<OpenAIAgentBriefingModel> logger, IOpenAIAgentBriefingRunner openAiBriefingRunner) : PageModel
{
    [BindProperty]
    ...
    {
        ViewData[TabNavigationModel.ViewDataKey] = new TabNavigationModel(TabNavigationModel.OpenAIAgent);
        return Page();
    }
