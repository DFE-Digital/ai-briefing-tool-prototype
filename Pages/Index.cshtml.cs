        ...
        IConcernsInformationRetriever concernsInformationRetriever) : PageModel
    {
        ...
        public async Task<string> RunAsync()
        {
            ...
            var messages = new List<ChatMessage>
            {
                ...
                //new SystemChatMessage(@$"Do not invent new concerns that are not part of the data"),
                new UserChatMessage(@$"Create a briefing for {AcademyName}"),
                new UserChatMessage($@"Include ofsted, concerns about the trust {AcademyName} is part of and overall data"),
                new UserChatMessage($@"Include ofsted, concerns about the trust {AcademyName} is part of and overall data"),
